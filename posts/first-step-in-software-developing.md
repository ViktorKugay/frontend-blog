---
id: first-step-in-software-developing
...
IT (информационные технологии) можно сравнить с большим симфоническим оркестром, где коллектив делится на отдельные группы инструментов, а группы на голоса. Каждый инструмент играет свою партию, но в целом все делают одно большое дело. Рассмотрим профессии в IT на примере списка курсов с популярной платформы [skillbox](https://skillbox.ru/code/):

- **Data Scientist**
  · [Анализ данных](https://skillbox.ru/course/profession-data-analyst/) — задача этих ребят знать где, что лежит, откуда нужно достать данные и куда положить, как перевести с языка баз данных, таблиц, строк в понятный всем язык бизнес задач
  · [Машинное обучение ](https://skillbox.ru/course/profession-machine-learning/)— эта профессия подходит для людей с хорошей математической базой, т.к. потребуется не просто обрабатывать данные, но создавать новые, уникальные модели и системы, анализировать данные и строить гипотезы

- **WEB разработчик**
  · [Frontend разработчик](https://skillbox.ru/course/frontend-pro-expert/) — кодит сайты и интерфейсы (Smart TV, интерфейсы в автомобилях, самолетах, индустриальных машинах)
  · [Full stack разработчик Python](https://skillbox.ru/course/profession-fullstack-python/) — Python не используется в браузерах (только JavaScript), поэтому этот курс подходит скорее для общего развития
  · [Full stack разработчик на PHP](https://skillbox.ru/course/profession-fullstack-php/) — аналогичная история; чтобы быть full stack разработчиком нужно быть очень скиловым и опытным парнем, в хороших командах писать важную, отказоустойчивую систему нанимают очень опытных людей, которые хорошо разбираются в своей специальности; приобрести эти навыки за один год на курсе full stack вряд-ли возможно
  · [Full stack разработчик на JavaScript](https://skillbox.ru/course/profession-fullstack-js/) — единственный язык, который может исполнятся прямо на странице в браузере, собственно говоря он и был создан для этого; курс подойдет если вы уже освоили базовые навыки и хотите дополнительно прокачаться

- **Backend разработчик**
  · [Python разработчик](https://skillbox.ru/course/profession-python/) — Python применяется в различных сферах, благодаря тому, что это язык имеет динамическую (просто и быстро писать) типизацию, однако, это же и его недостаток; часто применяется в Data Science
  · [Java разработчик](https://skillbox.ru/course/profession-java/) — противоположность Python, язык достаточно низкоуровневый, с возможностью управления памятью и параллельными процессами, это делает его более подходящим для универсальных и высоко нагруженных систем, будьте готовы потратить много времени на изучение нюансов языка
  · [Go разработчик](https://skillbox.ru/course/profession-godev/) — очень популярный язык программирования от Google, сейчас крайне востребован для создания бэкенд части приложений
  ...
  [ ](https://skillbox.ru/course/profession-c-plus-plus/)· [С++ разработчик](https://skillbox.ru/course/profession-c-plus-plus/) — один из фундаментальных языков программирования, который был создан еще в 1983 году; до сих пор актуален и крайне важен благодаря своей работе с памятью и потоками

- **DevOps
  **· [DevOps инженер](https://skillbox.ru/course/profession-devops/) — эти ребята гарантируют, что все, что Ты написал будет исправно работать на подходящем железе, обновления будут быстро поступать на серверы, а если Ты допустишь ошибку в коде и приложение упадет с ошибкой, то у DevOps инженеров уже настроен механизм нотификаций и они своевременно дадут Тебе знать, что с кодом беда

Я **не проходил** ни одного курса на skillbox, поэтому **не могу** рекомендовать, однако, сейчас это популярная платформа и многие ищущие с ней сталкиваются.

## Это сложно?

### Ответственность

Основным заказчиком ПО сегодня является бизнес, поэтому Ты будешь нести ответственность за деньги и имидж компании, в которой работаешь. Чем старше Ты будешь становиться, тем дороже будут стоить Твои решения, поэтому оценивай риски и моральный груз ответственности связанный с ним.

### График работы

Занятость очень сильно зависит от сферы:

- **стартапы** — крайне важны сроки реализации: кто первый выйдет на рынок с инновационной идеей тот и получит самую жирную долю рынка, поэтому в стартапах нет времени на отдых и поиск наиболее оптимальных решений, важно сделать рабочий продукт быстро

- **креативные агенства** — атмосфера близка к стартапам, но контекст постоянно меняется, т.к. часто меняются заказчики, есть время выдохнуть, но нет продукта, ради которого стоит трудиться и расти — все делаешь для какого-то абстрактного заказчика

- **кадровые агенства **— формально Ты работаешь в кадровом агенстве (там лежит твоя трудовая), но реально выполняешь задачи для крупной отечественной или зарубежной компании; работа в кадровом агенстве сопряжена с проблемами c карьерным ростом: можно много работать, полюбить коллектив, но уйти на полюбившееся место не получится — Ты связан договором с кадровым агенством

- **крупные компании**: _основной продукт_ — компании заботятся о стабильности продукта, репутационные потери связанные с ошибками или простоем стоят очень дорого, поэтому большое количество времени уделяется качеству кода: [code review](https://ru.wikipedia.org/wiki/%D0%9F%D1%80%D0%BE%D1%81%D0%BC%D0%BE%D1%82%D1%80_%D0%BA%D0%BE%D0%B4%D0%B0), планированию: [agile](https://ru.wikipedia.org/wiki/%D0%93%D0%B8%D0%B1%D0%BA%D0%B0%D1%8F_%D0%BC%D0%B5%D1%82%D0%BE%D0%B4%D0%BE%D0%BB%D0%BE%D0%B3%D0%B8%D1%8F_%D1%80%D0%B0%D0%B7%D1%80%D0%B0%D0%B1%D0%BE%D1%82%D0%BA%D0%B8), [scrum](https://ru.wikipedia.org/wiki/SCRUM) и надежной, отказоустойчивой архитектуре

- **крупные компании**: _побочные продукты_ — одно из самых интересных направлений, где можно получить уникальный опыт разработки в крупной компании и почувствовать относительную свободу стартапа
...
Суммарно получается около **10-ти часов в день**, учитывая саморазвитие.

Оценивай Твои силы и мотивацию. Особенно большое значение уделяй **выбору работодателя**. Ты должен чувствовать, что каждый час работы приносит Тебе **рост и удовольствие**, иначе через несколько лет работы можно выгореть.

### Рост и развитие

Супер важная вещь в любой профессии. Разработка ПО это стремительно развивающаяся сфера. Настолько стремительно, что академические учебные направления неспособны сформировать актуальные программы. Это невозможно, т.к. в разработке ПО** есть фундаментальные концепции**, но **нет фундаментального инструментария**. Тебе нужно потратить собственные силы для нахождения опытного ментора или наставника, который будет помогать Тебе расти. Чем больше опыта Ты будешь приобретать, тем сложнее это будет делать.

Однако, в отличие от многих профессий, **работодатель очень заинтересован** в Твоем росте. Чем опытнее его сотрудники, тем более качественный, надежный и эффективный код они пишут. Поэтому часто работодатели **поддерживают сотрудников **и их учебную активность, если она напрямую коррелирует с ролью человека в команде.

## Как стать разработчиком?

### Академическое образование

Есть уникальные места (гос. структуры или некоторые зарубежные работодатели), где смотрят на диплом, но работодатель платит Тебе не за красную корочку, а за результат. Если Ты скиловый парень, который может сделать продукт и заработать денег для компании — Тебе будут очень рады.
...
- [Tinkoff Fintech](https://fintech.tinkoff.ru/) — программа сотрудничает с лучшими университетами Москвы и позволяет получить релевантные знания и опыт от разработчиков самого технически продвинутого, демократичного и эффективного банка России
...
Как Ты уже понял 😀, я учился в Tinkoff Fintech и это место, эти люди помогли дать старт моей карьере в мире IT. Определенно, они изменили мою жизнь к лучшему 😍
...
“И в мире нет таких вершин, что взять нельзя” пел Высоцкий. От Твоей мотивации зависит Твое будущее. Нельзя научиться быть гением, но можно сделать из себя хорошего, востребованного профессионала.

Все зависит только от Тебя и твоего умения правильно ставить цели, планировать время и способности найти свое любимое дело.

Как писал Карлос Кастанеда:
